# Issue 11: Implement Databases List Endpoint

## Status
⏳ **TODO**

**Estimated Time:** 2 hours
**Branch:** `issue/11-databases-list-endpoint`
...
git checkout -b issue/11-databases-list-endpoint
...
git commit -m "feat(issue-11): implement GET /api/databases endpoint"
git push origin issue/11-databases-list-endpoint
```
