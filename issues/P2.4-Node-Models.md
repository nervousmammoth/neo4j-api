...
**As a** developer
**I want** comprehensive node operation models (detail, expand, count)
**So that** I can implement type-safe node retrieval and expansion endpoints with proper validation
