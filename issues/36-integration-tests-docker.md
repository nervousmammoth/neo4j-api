# Issue 36: Integration Tests with Docker Neo4j

## Status
⏳ **TODO**

**Estimated Time:** 1-2 hours
**Branch:** `issue/36-integration-tests-docker`
...
## Dependencies
- [x] Issue #10 - Health check endpoint (already implemented)
...
git checkout -b issue/36-integration-tests-docker
```
...
git push origin issue/36-integration-tests-docker
```
