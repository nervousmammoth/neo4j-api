...
**As an** API consumer
**I want** the health endpoint to return consistent response types for all status codes
**So that** my code generation tools can create correct type definitions and my applications can handle both healthy and unhealthy states consistently
