...
**I want** a Caddy reverse proxy configuration with automatic HTTPS
**So that** I can easily deploy the API with security, rate limiting, and professional routing without manual certificate management
