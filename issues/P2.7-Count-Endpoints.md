...
**As an** API consumer
**I want** to get counts of nodes and edges in the database
**So that** I can understand the graph size, monitor data growth, and make informed decisions about queries and performance
