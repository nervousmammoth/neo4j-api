...
**As an** API consumer
**I want** to retrieve all node labels from the database schema
**So that** I can understand what types of nodes exist and build dynamic queries or visualizations
