...
**Status:** To Do
**Priority:** P4
**Branch:** `feature/P4.3-Systemd-Service`
---
...
**I want** a systemd service unit file with automatic restart and security hardening
**So that** I can run the API as a reliable system service that automatically recovers from failures and follows security best practices
...
git checkout -b feature/P4.3-systemd-service
...
git commit -m "feat(P4.3): create systemd service unit file"
git push origin feature/P4.3-systemd-service
```
