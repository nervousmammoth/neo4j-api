...
**As a** developer
**I want** schema response models for node and edge types
**So that** I can implement type-safe schema discovery endpoints that help API consumers understand the graph structure
