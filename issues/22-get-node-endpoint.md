# Issue 22: Implement Get Node by ID Endpoint

## Status
⏳ **TODO**

**Estimated Time:** 2 hours
**Branch:** `issue/22-get-node-endpoint`
...
git checkout -b issue/22-get-node-endpoint
...
git commit -m "feat(issue-22): implement get node by ID endpoint"
git push origin issue/22-get-node-endpoint
```
