...
**As a** developer
**I want** integration tests that work with Docker Neo4j and proper separation from unit tests
**So that** I can test the API against a real database without requiring a local Neo4j installation, and push code without integration test dependencies
