# Issue 14: Implement Query Execution Endpoint (Basic)

## Status
⏳ **TODO**

**Estimated Time:** 3 hours
**Branch:** `issue/14-query-endpoint-basic`
**Phase:** 3 - Query Execution

## Description
Implement `POST /api/{database}/graph/query` endpoint in `app/routers/query.py` for Cypher query execution. This implements basic functionality without validation (validation added in Issue #15).
...
- [ ] Issue #08 - API key auth
- [ ] Issue #13 - Query models
...
git checkout -b issue/14-query-endpoint-basic
...
git commit -m "feat(issue-14): implement basic query execution endpoint"
git push origin issue/14-query-endpoint-basic
```
...
## Notes
- Query validation will be added in Issue #15
