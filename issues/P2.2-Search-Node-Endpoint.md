...
git checkout -b feature/P2.2-search-node-endpoint
...
git commit -m "feat(P2.2): implement node search endpoint with fuzzy matching"
git push origin feature/P2.2-search-node-endpoint
```
