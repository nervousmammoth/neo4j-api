...
echo -e "  ${GREEN}✓${NC} pre-push    - Tests with 100% coverage requirement\n"
...
echo -e "\n  • On ${YELLOW}git push${NC}: Comprehensive testing (~1-2 minutes)"
echo -e "    - Unit tests with 100% coverage requirement"
echo -e "    - BDD smoke tests"
echo -e "    - Full BDD test suite\n"
